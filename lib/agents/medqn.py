...
def mdqn(env,num_episodes,exploration,gamma,lr, epsilon,epsilon_decay,decay_steps,initial_run,qNet):
    ...
    originalqNet = copy.deepcopy(qNet)

    # print("mdqn.py: qNet[0].weight.data(), episode start")
    ...
    # print("mdqn.py: qNet[0].weight.data(), episode end")
    # print(qNet[0].weight.data())

    originalqNet[0].weight.data()[:] = originalqNet[0].weight.data()[:] + (originalqNet[0].weight.data()[:]- qNet[0].weight.data()[:]) * metalr
    originalqNet[1].weight.data()[:] = originalqNet[1].weight.data()[:] + (originalqNet[1].weight.data()[:]- qNet[1].weight.data()[:]) * metalr
    originalqNet[2].weight.data()[:] = originalqNet[2].weight.data()[:] + (originalqNet[2].weight.data()[:]- qNet[2].weight.data()[:]) * metalr
    qNet[0].weight.data()[:] = originalqNet[0].weight.data()[:]
    qNet[1].weight.data()[:] = originalqNet[1].weight.data()[:]
    qNet[2].weight.data()[:] = originalqNet[2].weight.data()[:]
